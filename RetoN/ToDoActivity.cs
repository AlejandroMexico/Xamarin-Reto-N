...
namespace RetoN
{
    ...
    public class ToDoActivity : Activity
    {
        ...
        protected override async void OnCreate(Bundle bundle)
        {
            ...
            Button rep = FindViewById<Button>(Resource.Id.buttonAddTorneo);
            rep.Click += Rep_Click;
        ...
        private async void Rep_Click(object sender, EventArgs e)
        {
            string AndroidId = Android.Provider.Settings.Secure.GetString(ContentResolver, Android.Provider.Settings.Secure.AndroidId);
            
            await helper.InsertarEntidad("Magodioz3@live.com", "RetoN+488b1", AndroidId);
            Toast.MakeText(this, "En el reto Completado", ToastLength.Long).Show();
